...
if($q['j1']==$q['jawab']){ $menjawab='A';}
	...
	echo" 
	<li><div class='bulatan'>$menjawab</div><input type='radio' id='$hal' name='nomer' value='$hal' onclick=\"document.form_cek.action = 'acak1.php'; document.form_cek.method='get'; document.form_cek.submit(); return false;\" $cek>
...
if($nomer>$bataspil){
	echo " <br>
<tr><td><input type='text' name='jwbisian' value='$jwbisian1' autocomplete='off'> </td></tr>";
} else{
echo"
...
<div class='back'>
	...
	echo "
<div class='back'>
<a href='' onclick=\"document.form_cek.action = 'back1.php'; document.form_cek.method='get'; document.form_cek.submit(); return false;\">
<div class='tombol1'>
...
echo "
<div class='next'>
<a href='' onclick=\"document.form_cek.action = 'simpan1.php'; document.form_cek.method='get'; document.form_cek.submit(); return false;\">
<div class='tombol1'>
