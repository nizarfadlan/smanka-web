...
<div class='jawaban'>
<form action='selesai4.php' name='form_cek' id='form_cek'>
...
if($q['j1']==$q['jawab']){ $menjawab='A';}
	...
	echo" 
	<li><div class='bulatan'>$menjawab</div><input type='radio' id='$hal' name='nomer' value='$hal' onclick=\"document.form_cek.action = 'acak4.php'; document.form_cek.method='get'; document.form_cek.submit(); return false;\" $cek>
...
<div class='back'>
	...
	echo "
<div class='back'>
<a href='' onclick=\"document.form_cek.action = 'back4.php'; document.form_cek.method='get'; document.form_cek.submit(); return false;\">
<div class='tombol1'>
...
echo "
<div class='next'>
<a href='' onclick=\"document.form_cek.action = 'simpan4.php'; document.form_cek.method='get'; document.form_cek.submit(); return false;\">
<div class='tombol1'>
