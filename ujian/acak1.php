...
if($pembatas<$urutan){
	...
	$kunci2=$a['kunci2'];
	$kunci3=$a['kunci3'];
if($kunci1==$jawaban or $kunci2==$jawaban or $kunci3==$jawaban){
	$hitung=1;}
else{$hitung=0;};
...
echo "<script>;window.location='home1.php?id=$mapel&no=$lari&user=$user&jml=$jumlah&dtk=$detiknya&batas=$pembatas'</script>";
