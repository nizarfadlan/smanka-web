...
$bataspil=$_GET['batas'];
				...
				$sqlsoal=mysqli_query($kon, "select * from soalmtk where id_mapel='$idmapel'");
...
for($hal=1; $hal<=$jumlah; $hal++){
	...
	echo" 
	<li><div class='bulatan'></div><input type='radio' id='$hal' name='nomer' value='$hal' onclick=\"document.form_cek.action = 'acak17.php'; document.form_cek.method='get'; document.form_cek.submit(); return false;\" >
...
if($nomer>$bataspil){
	echo " <br>
<tr><td><input type='text' name='jwbisian' value='' autocomplete='off'> </td></tr>";
} else{
	echo"
...
<div class='back'>
	...
	echo "
<div class='back'>
<a href='' onclick=\"document.form_cek.action = 'balik3.php'; document.form_cek.method='get'; document.form_cek.submit(); return false;\">
<div class='tombol1'>
...
echo "
<div class='next'>
<a href='' onclick=\"document.form_cek.action = 'lanjut3.php'; document.form_cek.method='get'; document.form_cek.submit(); return false;\">
<div class='tombol1'>
