...
echo"
<div class='list23'> <div class='nosoal' style='display:block;cursor:pointer' onclick='openNav()'>Daftar<br>Soal</div>
...
<audio controls controlsList='nodownload'>
	<source src='audio/$muncul[listening]' type='audio/ogg'>
...
if($q['j1']==$q['jawab']){ $menjawab='A';}
	...
	echo" 
	<li><div class='bulatan'>$menjawab</div><input type='radio' id='$hal' name='nomer' value='$hal' onclick=\"document.form_cek.action = 'acak3.php'; document.form_cek.method='get'; document.form_cek.submit(); return false;\" $cek>
...
<div class='back'>
	...
	echo "
<div class='back'>
<a href='' onclick=\"document.form_cek.action = 'back2.php'; document.form_cek.method='get'; document.form_cek.submit(); return false;\">
<div class='tombol1'>
...
echo "
<div class='next'>
<a href='' onclick=\"document.form_cek.action = 'simpan2.php'; document.form_cek.method='get'; document.form_cek.submit(); return false;\">
<div class='tombol1'>
