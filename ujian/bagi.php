...
$ambil=mysqli_query($kon, "select tanya, urutan, jawab, ragu, j1,j2, j3, j4, j5, A, B, C, D, E, pertanyaan from soal inner join $nama on soal.no_soal=$nama.tanya and soal.id_mapel=$nama.id_mapel where $nama.id_mapel='$idmapel' and $nama.user='$nouser' and urutan='$nomer'") or die ("Query Gagal ".mysqli_error());
