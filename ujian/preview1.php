...
for($hal=1; $hal<=$jumlah; $hal++){
	...
	echo" 
	<li><div class='bulatan'></div><input type='radio' id='$hal' name='nomer' value='$hal' onclick=\"document.form_cek.action = 'acak15.php'; document.form_cek.method='get'; document.form_cek.submit(); return false;\" >
...
<div class='back'>
	...
	echo "
<div class='back'>
<a href='' onclick=\"document.form_cek.action = 'balik.php'; document.form_cek.method='get'; document.form_cek.submit(); return false;\">
<div class='tombol1'>
...
echo "
<div class='next'>
<a href='' onclick=\"document.form_cek.action = 'lanjut.php'; document.form_cek.method='get'; document.form_cek.submit(); return false;\">
<div class='tombol1'>
