...
if($ira=='wrdwesfer453445g64dsdsferw44fewdfsd'){
header("refresh: 15"); 
...
mysqli_query($kon,"update qrcode set qrcode='$nilaitoken', gambar='$nilaitoken1' where id_qr='e'");

$eko=mysqli_query($kon, "select * from qrcode where id_qr='e'");
$ek=mysqli_fetch_array($eko);

$hasil=$ek['qrcode'];
QRcode::png("$hasil", "siswa.png", "L", 8, 8);

echo"

<div class=qr'><img src='siswa.png' width='500px'></div>
