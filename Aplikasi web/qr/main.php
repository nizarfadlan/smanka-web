...
mysqli_query($kon, "UPDATE pengumuman SET konten='$_POST[umum]'
...
$rrg=mysqli_query($kon, "select * from pengumuman where id_pengumuman='1'");
$fr=mysqli_fetch_array($rrg);				
echo"
            ...
            <div class='col-sm-12'>
                 ...
                 <div class='card'>
					  ...
					  <form method='post'  action='' class='form-horizontal'>
						 ...
						 <textarea name='umum' id='eko' class='form-control-label'>$fr[konten] </textarea> 
...
mysqli_query($kon, "INSERT INTO jadwal_kerja(id_anggota,nama,senin,selasa,rabu,kamis,jumat,sabtu,minggu) VALUES ('$r[id_anggota]','$r[nama]' , 'ON' ,'ON' ,'ON' ,'ON' ,'ON' ,'OFF','OFF')")or die (mysqli_error($kon));
